...
class GeographyService:
    ...
    async def validate_block_exists(
        db: AsyncSession, block_id: int, district_id: Optional[int] = None
    ) -> Block:
    ...
    @staticmethod
    async def validate_village_exists(
    ...
    @staticmethod
    async def get_district_with_counts(
        db: AsyncSession, district_id: int
    ) -> Dict[str, Any]:
    ...
    @staticmethod
    async def get_village_with_counts(
        db: AsyncSession, village_id: int
    ) -> Dict[str, Any]:
